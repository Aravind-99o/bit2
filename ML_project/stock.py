...
for symbol in stock_symbols:
    ...
    if not real_time_data.empty:
        ...
        last_price = real_time_data['Close'].iloc[-1]  # Get the last price as a scalar value
        change = last_price - real_time_data['Open'].iloc[0]  # Get the change as a scalar value
        pct_change = (change / real_time_data['Open'].iloc[0]) * 100  # Get the percentage change
        
        # Format the values as floats for proper display in Streamlit
